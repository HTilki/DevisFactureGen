...
class PDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 5, "9 Avenue Pierre Corneille, 28500 VERNOUILLET", 0, 1, "L")
        self.cell(0, 5, "Mail: hamida28@hotmail.fr", 0, 1, "L")
        self.cell(0, 5, "Tél: 0629570458", 0, 1, "L")
        self.cell(0, 5, "SIRET: 522 041 995 00013 - APE 4520A", 0, 1, "L")
